...
export function Footer() {
  return (
    <footer className="py-8 sm:py-10 bg-gray-900 border-t border-dotnet-purple/20 relative">
      ...
      <Container className="relative z-10">
        <div className="flex flex-col gap-5 sm:gap-6">
          ...
          {/* Footer Text */}
          <div className="text-center space-y-1 border-t border-gray-800 pt-5 sm:pt-6">
            <p className="text-sm sm:text-base text-gray-300 leading-relaxed px-4">
              A free community event by developers, for developers
            </p>
            <p className="text-xs sm:text-sm text-gray-400">
              Made with <span className="text-red-400">❤</span> in Bangkok, Thailand
            </p>
          </div>
        </div>
      </Container>
