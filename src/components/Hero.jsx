...
export function Hero() {
  return (
    <div className="relative pt-12 pb-32 sm:pt-32 sm:pb-40 lg:pt-40 lg:pb-48 bg-gradient-to-b from-gray-900 via-dotnet-purple-dark to-gray-900 overflow-hidden min-h-[90vh] flex items-center">
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute right-0 top-[60%] sm:top-[55%] -translate-y-1/2 w-2/5 sm:w-1/2 max-w-2xl opacity-50 sm:opacity-75 animate-float">
          <Image
      ...
      <Container className="relative w-full">
        <div className="mx-auto max-w-2xl lg:max-w-4xl lg:px-12">
          ...
          <div className="mt-6 sm:mt-8 space-y-4 sm:space-y-6 font-display">
